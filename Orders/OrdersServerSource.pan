...
case OrderNo > 700000 and OrderNo<1000000
    ...
    GrTotal=«OrderTotal»+Donation+Membership+CatalogDefrayment
    RealTax=SalesTax
...
case OrderNo > 400000 and OrderNo < 500000
    ...
    OrderTotal=AdjTotal+SalesTax+Surcharge+«$Shipping»
    GrTotal=«OrderTotal»+Donation+«Donation2»+CatalogDefrayment
    RealTax=SalesTax
    Patronage=«OrderTotal»-RealTax
...
case OrderNo > 500000 and OrderNo < 600000
    ...
    OrderTotal=AdjTotal+SalesTax+Surcharge+«$Shipping»
    GrTotal=«OrderTotal»+CatalogDefrayment
    RealTax=SalesTax
    Patronage=«OrderTotal»-RealTax
endcase
...
if ShipCode contains "P" or ShipCode contains "T"
    ...
    if arraycontains(taxstates+","+noship,TaxState,",")=0
        TaxRate=0
        StateRate=0
        CountyRate=0
        CityRate=0
