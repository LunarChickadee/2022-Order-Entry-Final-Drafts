...
searchname=""
searchcust=""
;window "43 mailing list:addresschecker"
;field Cit
gosheet
noshow
...
lastrecord
insertbelow
«C#»=grabdata("43 mailing list", «C#»)
Con=grabdata("43 mailing list", Con)
Group=grabdata("43 mailing list", Group)
MAd=grabdata("43 mailing list", MAd)
City=grabdata("43 mailing list", City)
St=grabdata("43 mailing list", St)
Zip=grabdata("43 mailing list", Zip)
SAd=grabdata("43 mailing list", SAd)
Cit=grabdata("43 mailing list", Cit)
Sta=grabdata("43 mailing list", Sta)
Z=grabdata("43 mailing list", Z)
phone=grabdata("43 mailing list", phone)
email=grabdata("43 mailing list", email)
inqcode=grabdata("43 mailing list", inqcode)
«Mem?»=grabdata("43 mailing list", «Mem?»)
windowtoback "members"
window "43 mailing list"
...
;downrecord
;window "43 mailing list:customer history"
;else
;downrecord
;endif
if info("formname")="addresschecker"
downrecord
window "43orders:seedsinput"
downrecord
window "43 mailing list:addresschecker"
endif
defaultcase
...
if info("files") contains "43orders"
goto continue
else
opensecret "43orders"
endif
...
St=grabdata("43 mailing list", St)
Zip=grabdata("43 mailing list", Zip)
SpareText2=grabdata("43 mailing list", SpareText2)
...
supergettext findher, {caption="Enter Address.Zip" height=100 width=400 captionfont=Times captionsize=14 captioncolor="cornflowerblue"
    ...
    if info("dialogtrigger") contains "Find"
        ...
        liveclairvoyance findzip,listzip,¶,"","43 mailing list",pattern(Zip,"#####"),"=",str(«C#»)+¬+rep(" ",7-length(str(«C#»)))+Con+rep(" ",max(20-length(Con),1))+¬+MAd+¬+City+¬+St+¬+pattern(Zip,"#####"),0,0,""
...
tryname:
    ...
    if info("dialogtrigger") contains "Find"
        liveclairvoyance lastname,findname1,¶,"","43 mailing list",Con,"contains",Con+¬+MAd+¬+City+¬+St+¬+pattern(Zip,"#####")+¬+phone,0,0,""
        message findname1
    endif
...
local address
UpRecord
arraylinebuild address,¬,"43 mailing list", City+¬+St+¬+str(Zip)+¬+str(adc)+¶
DownRecord
...
case searchcust≠""
liveclairvoyance searchcust, findcust, ¶, "CustomerList","43 mailing list", str(«C#»), "beginswith", str(«C#»), 10, 0, ""
case searchname≠""
liveclairvoyance searchname, findname, ¶, "NameList","43 mailing list", Con, "match", str(«C#»)+": "+Con, 10, 0, ""
endcase
