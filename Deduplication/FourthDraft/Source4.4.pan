...
case str(parameter(1))="user"
New_Master_CNum=lowest_C
New_Master_Record=merge_sequence_num

//___confirm the user really does want to use their own edits vs picking from a record that already exists
if info("summary")>0
    yesno "Are you merging a summary record you edited yourself?"
        if clipboard()="No"
            stop
        endif
endif
...
//__Label that it's a desitnation for future use
if clipboard()="Yes"
